...
public class inbox extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<String> m = getSms();
        setListAdapter(new StringArrayAdapter(this, R.layout.inbox, m));

        ListView listView = getListView();
        listView.setTextFilterEnabled(true);
////        setContentView(R.layout.inbox);
//        listView = (ListView) findViewById(R.id.inbox_text);
////        tv = (TextView) findViewById(R.id.inbox_text);
////        List<String> m = getSms();
//
//        String[] m = {"red", "blue", "green"};
////        tv.append(m.toString());
//        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.inbox, m);
...
//        listView.setAdapter(new ArrayAdapter<String>(this, R.layout.inbox, m));

//        View speakButton_in = findViewById(R.id.speak_inbox_button);

//        speakButton_in.setOnClickListener(this);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        //get selected items
        String text = (String) getListAdapter().getItem(position);
        UNI2PASCI U = new UNI2PASCI();
        synthesis S = new synthesis();
        text = U.word_split(text);
        if (text != null && text.length() > 0) {
            Toast.makeText(inbox.this, "Saying: " + text, Toast.LENGTH_LONG).show();
            Pon(text);
            MediaPlayer mp = new MediaPlayer();

           try {
                mp.setDataSource("/sdcard/download/wave.wav");
    ...
    public class StringArrayAdapter extends ArrayAdapter<String> {
        ...
        public StringArrayAdapter(Context context, int textViewResourceId, List<String> mAnswerArray) {
            super(context, textViewResourceId, mAnswerArray);

            font = Typeface.createFromAsset(context.getAssets(), "font/vrinda.ttf");
        }
    ...
    public ArrayList<String> getSms() {
        Uri mSmsQueryUri = Uri.parse("content://sms/draft");
        ArrayList<String> messages = new ArrayList<String>();
        Cursor cursor = null;
        try {
            ContentResolver resolver = getContentResolver();
            cursor = resolver.query(mSmsQueryUri, null, null, null, null);
            if (cursor == null) {
